...
#import "https://api.firecloud.org/ga4gh/v1/tools/alexandria:cumulus/versions/1/plain-WDL/descriptor" as cumulus #TERRA

import "https://api.firecloud.org/ga4gh/v1/tools/cumulus:dropseq_workflow/versions/1/plain-WDL/descriptor" as dropseq #TERRA
import "https://api.firecloud.org/ga4gh/v1/tools/cumulus:cumulus/versions/2/plain-WDL/descriptor" as cumulus #TERRA
...
workflow dropseq_cumulus {
	...
	String cumulus_output_prefix = "cumulus"
	...
	#TODO: Support run_dropest input to cumulus
...
task ds_dummy {
	...
	output {
		Array[String] dge = if is_bcl == false then ["${output_directory}/B0_2/B0_2_dge.txt"] else ["${output_directory}/190712_non2/190712_non2_dge.txt.gz", "${output_directory}/3July19PB/3July19PB_dge.txt.gz", "${output_directory}/3July19BM/3July19BM_dge.txt.gz"]
	}
	runtime {
