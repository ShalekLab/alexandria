...
The Alexandria workflow version of dropseq_scCloud is intended as a user-accessible means of analyzing and visualizing single-cell RNA-seq data. Therefore, only essential parameters are exposed.  
...
* Do not upload sequence files into the root directory of the bucket, instead use `gsutil` to move them into a folder on your bucket. Example:  
